...
RSpec.describe User, type: :model do
  describe 'User account creation with valid credentials' do
    it 'validates user first names' do
      user = User.new(id: 4, last_name: 'lucky', email: 'aremu.baba70@gmail.com', password: 'passsing')
      expect(user).not_to be_valid
    end

    it 'First names should not be blank and not too short' do
      user = User.new(id: 4, last_name: 'aremu', email: 'aremu.baba70@gmail.com', password: 'passsing')
      user.save
    ...
    it 'validates user last name' do
      user = User.new(id: 4, first_names: 'aremu', email: 'aremu.baba70@gmail.com', password: 'passsing')
      expect(user).not_to be_valid
    end

    it 'last name should not be blank and not too short' do
      user = User.new(id: 4, first_names: 'lucky', email: 'aremu.baba70@gmail.com', password: 'passsing')
      user.save
    ...
    it 'User can create account with valid credentials' do
      user = User.new(id: 4, first_names: 'lucky', last_name: 'aremu', email: 'aremu.baba70@gmail.com', password: 'passsing')
      user.save
    ...
    it 'expect users to increase by one if credentials are valid' do
      expect do
        User.create(id: 4, first_names: 'lucky',
                    last_name: 'aremu', email: 'aremu.baba70@gmail.com', password: 'passsing')
