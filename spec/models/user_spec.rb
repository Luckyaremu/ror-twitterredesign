...
RSpec.describe User, type: :model do
  describe 'User account creation with valid credentials' do
    it 'validates user first names' do
      user = User.new(id: 4, last_name: 'aremu', email: 'user@example.com', password: 'passsing')
    ...
    it 'User can create account with valid credentials' do
      user = User.new(id: 4, first_names: 'Aremu', last_name: 'Lucky', email: 'user@example.com', password: 'passsing')
      user.save
    ...
    it 'expect users to increase by one if credentials are valid' do
      expect do
        User.create(id: 4, first_names: 'Aremu',
                    last_name: 'lucky', email: 'user@example.com', password: 'passsing')
